                     ...
                     <div class="item form-group">
                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-5">
                          ...
                          -->
                          <select id="supname" name="supname" class="form-control col-md-7 col-xs-5">
                            <c:forEach items="${supplyList}" var="supplys">
                                <option value="${supplys.suppname}">${supplys.suppname}</option>
                            </c:forEach>
                          </select>
                        </div>
                      </div>                      
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-5">
                          ...
                          -->
                          <select id="protype" name="protype" class="form-control col-md-7 col-xs-5">
                              <c:forEach items="${productTypeList}" var="productType">
                              <option value="${productType.typename}">${productType.typename}</option>
                              </c:forEach>
                          </select>
                        </div>
                      </div>                      
