...
public class MProductController {
	...
	@Autowired
	ITypeService iTypeServiceImp;

	@Autowired
	ISupplyMapperService iSupplyMapperServiceImp;
...
//  跳转到增加页面
  ...
  public String toaddpro(HttpServletRequest request,Model model){
	List<Type> productTypeList=iTypeServiceImp.getall();
	model.addAttribute("productTypeList",productTypeList);
	List<Supply> supplyList=iSupplyMapperServiceImp.getall();
